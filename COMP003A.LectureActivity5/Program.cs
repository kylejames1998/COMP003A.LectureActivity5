// Author: Kyle James
// Course: COMP003A
// Purpose: COMP003A Lecture Activity 5
...
namespace COMP003A.LectureActivity5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Methods and XML Comments");
            Console.WriteLine("".PadRight(50, '*'));
            ...
            HelloWorld("Alan Turning", DateTime.Now.Year - 1912); // call to HelloWorld(string name, int inputAge), which is an overloaded method
            ...
            Console.WriteLine($"Summation: {sum}"); // outputs the value of sum to console
            ...
            // below is an example of a method calling itself, alos known as recursion
            Console.WriteLine("\n");
        ...
        // if you type '///' on top of a class or method, visual studio will populate the structure for you
        // <summary></summary> used to describea type member
        ...
        /// <summary>
        /// Method for adding 2 numeric variables
        /// </summary>
        /// <param name="num1">Decimal input</param>
        /// <param name="num2">Decimal Input</param>
        /// <returns>Sum of 2 decimal inputs</returns>
        ...
        /// <summary>
        /// Method for subtracting 2 numeric values
        /// </summary>
        /// <param name="num1">Decimal input</param>
        /// <param name="num2">Decimal Input</param>
        /// <returns>Difference of 2 decimal inputs</returns>
        ...
        /// <summary>
        /// method for multiplying 2 numeric variables
        /// </summary>
        /// <param name="num1">Decimal input</param>
        /// <param name="num2">Decimal input</param>
        /// <returns>Product of 2 decimal inputs</returns>
        ...
        /// <summary>
        /// method for dividing 2 numeric variables
        /// </summary>
        /// <param name="num1">Decimal input</param>
        /// <param name="num2">Decimal input</param>
        /// <returns>Quotient of 2 decimal inputs</returns>
        ...
        /// <summary>
        /// method for getting the remainder of 2 numeric variables
        /// </summary>
        /// <param name="num1">Decimal input</param>
        /// <param name="num2">Decimal input</param>
        /// <returns>Remainder after dividing 2 decimal inputs</returns>
